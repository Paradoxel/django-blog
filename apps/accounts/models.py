...
class Status(models.TextChoices):
    """Possible states of a writer request."""
...
class WriterRequest(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL,on_delete=models.CASCADE,related_name='writer_requests')
    ...
    class Meta:
        ordering = ['-created_at']
        verbose_name = "Writer request"
        verbose_name_plural = "Writer requests"
